...
{
    public static Dependency<UnionHandler<T>> Join<THandler1, THandler2, THandler3, THandler4, THandler5, T>(
        this Dependency<THandler1, THandler2, THandler3, THandler4, THandler5> dependency)
        ...
        where THandler5 : IHandler<T, Unit>
    {
        ...
        static UnionHandler<T> CreateUnionHandler(
            THandler1 handler1, THandler2 handler2, THandler3 handler3, THandler4 handler4, THandler5 handler5)
        {
            ...
            return new(handler1, handler2, handler3, handler4, handler5);
        }
    }
}