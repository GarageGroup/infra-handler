...
{
    public static Dependency<UnionHandler<T>> Join<THandler1, THandler2, THandler3, THandler4, THandler5, THandler6, THandler7, T>(
        this Dependency<THandler1, THandler2, THandler3, THandler4, THandler5, THandler6, THandler7> dependency)
        ...
        where THandler7 : IHandler<T, Unit>
    {
            ...
            THandler7 handler7)
        {
            ...
            return new(handler1, handler2, handler3, handler4, handler5, handler6, handler7);
        }
    }
}